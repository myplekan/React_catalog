...
export const PhonesPage = () => {
  ...
  const lastItem =
    currentPage * +itemsOnPage > maxItems
      ? maxItems
  ...
  return (
    <div className="phones__container">
      <div className="phones__way">
        <Link to="/" className="phones__way--flex">
          <svg
        ...
        <>
          ...
          <section className="phones-card__container" data-cy="cardsContainer">
            {pageItems.map((product) => (
              <ProductCard key={product.id} product={product} firstPhone={0} />
            ))}
          </section>
      ...
      {pageItems.length < 1 && <PhoneNotFoundPage />}
    </div>
  );
};
