      ...
      {!loading && (
        <div className="banner">
          <div className="banner__container">
            <button className="left-arrow" type="button" onClick={bannerPrev}>
              <svg
            ...
            <ul className="banner__list">
              <li
                ...
                style={{
                  transform: `translateX(${-(transformWidth * firstImage)}px)`,
            ...
            <button className="right-arrow" type="button" onClick={bannerNext}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
