...
import categoryAccessories from "../../images/banner-accessories.png";
import * as actionsProduct from "../../features/products";
...
export const ProductsSlider: React.FC = () => {
  ...
  const hotPricePhones = products
    .filter((product: Product) => +product.year < CurrentYear)
    .sort((a: Product, b: Product) => +a.price - +b.price)
    .reverse();

  const brendNewProducts = products
    .filter((product: Product) => +product.year === CurrentYear)
    .sort((a: Product, b: Product) => +a.fullPrice - +b.fullPrice)
    .reverse();
    ...
    <>
      <div className="product-slider">
        <div className="product-slider__top">
          ...
          <div className="product-slider__top-buttons">
            ...
            <button
              type="button"
              className={`product-slider__top-button-prev ${
                firstPhone === hotPricePhones.length - 4 ? "disabled" : ""
              }`}
        ...
        <div className="product-card__container" data-cy="cardsContainer">
          {hotPricePhones.map((product: Product) => (
            <ProductCard
              key={product.id}
              product={product}
      ...
      <div className="brandNew">
        <div className="product-slider__top">
          ...
          <div className="product-slider__top-buttons">
            ...
            <button
              type="button"
              className={`product-slider__top-button-prev ${
                firstPhoneNew === hotPricePhones.length - 4
                  ? "disabled"
                  : ""
              }`}
        ...
        <div className="product-card__container" data-cy="cardsContainer">
          {brendNewProducts.map((product: Product) => (
            <ProductCard
              key={product.id}
              product={product}
