...
import { AppContext } from '../AppContex.tsx';
import { getSearchWith } from '../../utils/searchHelper.ts';
...
export const Header = () => {
  ...
  const getLinkClassFav = (
    ...
    { 'is-active': isActive }, { 'header__none': pageWidth < 640 });
      ...
      {pathname !== '/menu' && (
        <header className="header">
          ...
          <section className="header__rightSide">
            ...
            <button className='header__icon header__icon--menu' onClick={() => setIsMenu(true)}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      {isMenu && (
        <div className='menu menu--on' id='menu'>
          <div className="menu__top">
            ...
            <button className='header__icon header__icon--menu' onClick={() => setIsMenu(false)}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
