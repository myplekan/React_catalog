...
export const Header = () => {
  ...
  const getLinkClassNav = ({ isActive }: { isActive: boolean }) =>
    classNames("nav-item", { "is-active": isActive });

  const getLinkClassFav = ({ isActive }: { isActive: boolean }) =>
    classNames(
      "header__favorite",
      { "is-active": isActive },
      { header__none: pageWidth < 640 },
    );
  ...
  const itemCount = cart.reduce((total: number, item: Cart) => {
  ...
  return (
    <>
      {pathname !== "/menu" && (
        <header className="header">
              ...
              <nav className="header__nav nav">
                <ul className="nav__list">
                  <li className="nav-link">
                    <NavLink to="/" className={getLinkClassNav}>
                      Home
                    </NavLink>
                  </li>
                  <li className="nav-link">
                    <NavLink to="/phones" className={getLinkClassNav}>
                      Phones
                    </NavLink>
                  </li>
                  <li className="nav-link">
                    <NavLink to="/tablets" className={getLinkClassNav}>
                      Tablets
                    </NavLink>
                  </li>
                  <li className="nav-link">
                    <NavLink to="/accessories" className={getLinkClassNav}>
                      Accessories
                    </NavLink>
                  </li>
                </ul>
          ...
          <section className="header__rightSide">
            ...
            {pathname !== "/cart" && (
              <NavLink to="/favourites" className={getLinkClassFav}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <NavLink to="/cart" className={getLinkClassCart}>
              ...
              {cart.length > 0 && (
                <div className="header__favorite-number">{itemCount}</div>
              )}
            </NavLink>
      ...
      {isMenu && (
        <div className="menu menu--on" id="menu">
          ...
          <div className="menu__bottom">
            <nav className="nav">
              <ul className="nav__list nav--center">
                <li className="nav-link">
                  <NavLink to="/" className={getLinkClassNav}>
                    Home
                  </NavLink>
            ...
            <div className="menu__bottom-buttons">
              <NavLink to="/favourites" className={getLinkClassFav}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
